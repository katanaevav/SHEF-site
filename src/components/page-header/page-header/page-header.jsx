      ...
      <React.Fragment>
        ...
        <header className="page-header">
          <div className="page-header__wrapper">
            ...
            <a className="page-header__logo" onClick={this._onMainClickHandler}>
            ...
            <a className="page-header__basket" href="#" onClick={this._onCartClickHandler}>{`${totalCost} р. `} <img className="page-header__basket-image" src="./img/shopping-basket.svg" width="25" height="22" alt="Корзина" /></a>
          </div>
